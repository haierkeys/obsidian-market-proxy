...
let proMap = {
    ...
    "h.api.99988866.xyz": {
        down: "https://gh.api.99988866.xyz/https://github.com/"
        , raw: "https://gh.api.99988866.xyz/https://raw.githubusercontent.com/"
        , home: "https://gh.api.99988866.xyz/https://github.com/"
    },
}

let include = [
    {
        match: (url) => url.startsWith("https://github.com/") > 0 && url.indexOf("/releases/download/") >= 0
...
function eisURL(e) {
    ...
    if (include[1].match(e.url) || include[2].match(e.url)) {
        return true;
    } else {
        return false;
    }
